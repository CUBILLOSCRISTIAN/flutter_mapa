...
class HomePage extends GetView<AuthController> {
  ...
  FloatingActionButton _buildFloatingActionButtonGuide(
      RouteController rutaController) {
    return FloatingActionButton(
      onPressed: () {
        Get.dialog(
          AlertDialog(
            title: Text('¿Quieres crear una nueva ruta?'),
            content: Text(
                'Al crear una nueva ruta, serás asignado como guía. Como guía, tendrás la responsabilidad de iniciar y gestionar la ruta, asegurando que todos los participantes sigan el recorrido correctamente.'),
            actions: [
              TextButton(
                onPressed: () {
              ...
              TextButton(
                onPressed: () {
                  ...
                  Get.snackbar('Éxito', 'Has aceptado el diálogo');
                },
                child: Text('Aceptar'),
              ),
            ],
  ...
  FloatingActionButton _buildFloatingActionButtonParticipant(
      RouteController rutaController) {
    return FloatingActionButton(
      onPressed: () {
        Get.dialog(
          AlertDialog(
            ...
            content: Container(
              ...
              child: Column(
                children: [
                  Text(
                      'Digita el codigo de la ruta para unirte y disfrutar de esta experiencia.'),
                  TextField(
